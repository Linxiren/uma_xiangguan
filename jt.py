...
def perform_action(action_name):
    ...
    actions = {
        ...
        "呼出赛程": lambda: [adb_click(*BUTTONS['比赛']), adb_click(*BUTTONS['国外资质']), adb_click(*BUTTONS['参赛行程表']), adb_click(*BUTTONS['参赛行程表']), adb_click(*BUTTONS['赛程表一']), adb_click(*BUTTONS['关闭']), sleep(0.5), adb_click(*BUTTONS['确认']), adb_click(*BUTTONS['确认参赛']), sleep(0.5)],
